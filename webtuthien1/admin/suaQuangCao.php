...
<?php 
	...
	$row_quangcao = ChiTietQuangCao($idQuangCao);
?>
...
<body>
	...
	<form name="form1" method="post" action="">
	  <table id="table_sub" border="1">
	    <tr>
	      <td height="50" colspan="2"><h2>SỬA QUẢNG CÁO</h2></td>
        </tr>
	    <tr>
	      <td class="color" width="178" height="54">ViTri</td>
	      <td width="406">
	      	<div class="form-group">
	      		<input value="<?php echo $row_quangcao["ViTri"]; ?>" type="text" name="ViTri" class="form-control" id="ViTri" size="50" style="height:30px">
	      	</div>
	      </td>
        </tr>
	    <tr>
	      ...
	      <td><label for="MoTa"></label>
          	<input value="<?php echo $row_quangcao["MoTa"]; ?>" type="text" name="MoTa" id="MoTa" size="50" style="height:30px"></td>
        </tr>
        <tr>
	      <td class="color" height="44">Url</td>
	      <td><label for="Url"></label>
          	<input value="<?php echo $row_quangcao["Url"]; ?>" type="text" name="Url" id="Url" size="50" style="height:30px"></td>
        </tr>
        <tr>
	      <td class="color" width="183" height="54">urlHinh</td>
	      <td width="801">
	      	<div class="form-group">
	      		<input value="<?php echo $row_quangcao["urlHinh"]; ?>" type="text" name="urlHinh" class="form-control" id="urlHinh" size="50" style="height:30px;   ">
        ...
        <tr>
	      ...
	      <td><label for="SoLanClick"></label>
          	<input value="<?php echo $row_quangcao["SoLanClick"]; ?>" type="text" name="SoLanClick" id="SoLanClick" size="50" style="height:30px"></td>
        </tr>
	    <tr>
	      <td height="45"></td>
