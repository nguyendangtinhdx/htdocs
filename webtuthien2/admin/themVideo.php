...
<?php 
	if (isset($_POST["btnThem"])) {
		...
		$idTL = $_POST["idTL"];
			settype($idTL,"int");
		$SoLanXem = 0;
		$VideoNoiBat = $_POST["VideoNoiBat"];
			settype($VideoNoiBat,"int");
		$AnHien = $_POST["AnHien"];
			settype($AnHien,"int");
		$qr = "
			INSERT INTO  video  
			VALUES(null,'$TieuDe','$TieuDe_KhongDau','$TomTat','$Url','$urlHinh','$Ngay','$idUser','$idLT','$idTL','$SoLanXem','$VideoNoiBat','$AnHien')
		";
		mysql_query($qr);
...
<body>
	...
	<form name="form1" method="post" action="">
	  <table id="table_sub_themtin" border="1">
	    <tr>
	      <td height="50" colspan="2"><h2>THÊM VIDEO</h2></td>
        </tr>
	    <tr>
	      <td class="color" width="183" height="54">TieuDe</td>
	      <td width="801">
	      	<div class="form-group">
	      		<input type="text" name="TieuDe" class="form-control" id="TieuDe" size="100" style="height:30px">
	      	</div>
	      </td>
        </tr>
        <tr>
	      ...
	      <td width="801">
	      	<div class="form-group">
	      	  ...
	      	  <textarea name="TomTat" id="TomTat" style="height: 100px; width: 100%; "></textarea>
	      	</div>
	      </td>
        </tr>
        <tr>
	      ...
	      <td width="801">
	      	...
	      	<div class="form-group">
	      		<input type="text" name="Url" class="form-control" id="Url" size="50" style="height:30px;   ">
