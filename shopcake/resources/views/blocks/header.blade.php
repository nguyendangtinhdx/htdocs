						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{number_format(Session('cart')->totalPrice)}}{{-- {{number_format($product['item']['unit_price']+$product['item']['promotion_price'])}} --}} VNĐ</span></div>
									<div class="clearfix"></div>
					...
					<ul class="l-inline ov">
						...
						<li><a style="cursor: pointer;">Loại Sản phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="{{route('loai-sp',$loai->id)}}">{{$loai->name}}</a></li>
								@endforeach
							</ul>
						</li>
