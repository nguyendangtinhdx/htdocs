			...
			<div class="row">
				<div class="col-sm-12">
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsp',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt=""></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title">{{$new->name}}</p>
										<p class="single-item-price">
											@if($new->promotion_price==0)
											<span>{!! number_format($new["unit_price"],0,",",".") !!} VNĐ</span>
											@else
					...
					<div class="beta-products-list">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsp',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt=""></a>
									</div>
									<div class="single-item-body">
						...
						<div class="row" align="center">{{$sanpham_khuyenmai->links()}}</div>
