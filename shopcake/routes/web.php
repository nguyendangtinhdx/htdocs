...
Route::get('loai-san-pham/{type}',['as'=>'loai-sp','uses'=>'PageController@getLoaiSP']);
Route::get('chi-tiet-san-pham/{id}',['as'=>'chitietsp','uses'=>'PageController@getChiTietSP']);
...
Route::post('dat-hang',['as'=>'dathang','uses'=>'PageController@postDathang']);