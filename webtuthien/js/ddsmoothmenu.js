...
///////////////////////// Global Configuration Options: /////////////////////////
									   // 700px	
mobilemediaquery: "screen and (max-width: 1247px)", // CSS media query string that when matched activates mobile menu (while hiding default)
//Specify full URL to down and right arrow images (23 is padding-right for top level LIs with drop downs, 6 is for vertical top level items with fly outs):
arrowimages: {down:['downarrowclass', 'icon/down.gif', 23], right:['rightarrowclass', 'icon/right.gif', 6], left:['leftarrowclass', 'icon/left.gif']},
