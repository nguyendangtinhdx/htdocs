			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-block">
						...
						<input type="text" id="adress" name="addess" placeholder="Street Address" required>
					</div>
					...
					<div class="your-order">
						...
						<div class="your-order-body" style="padding: 0px 10px">
							...
							<div class="your-order-item">
								...
								<div class="pull-right"><h5 class="flash-sale">@if(Session::has('cart')){{number_format($totalPrice)}}@else 0 @endif VNĐ</h5></div>
								<div class="clearfix"></div>
							</div>
						</div>
							...
							<ul class="payment_methods methods">
								...
								<li class="payment_method_cheque">
									...
									<div class="payment_box payment_method_cheque" style="display: none;">
										...
										<br>- Chủ TK: Nguyễn Đăng Tỉnh
										<br>- Ngân hàng VietinBank, Chi nhánh Huế
									</div>						
								</li>
